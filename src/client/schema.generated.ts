...
/** Input for the createZombie mutation */
export interface CreateZombieInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The content of the object */
  content?: InputMaybe<Scalars["String"]>;
...
/** Input for the deleteZombie mutation */
export interface DeleteZombieInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the zombie to delete */
  id: Scalars["ID"];
}
...
/** Arguments for filtering the RootQueryToZombieConnection connection */
export interface RootQueryToZombieConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
/** Input for the updateZombie mutation */
export interface UpdateZombieInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The content of the object */
  content?: InputMaybe<Scalars["String"]>;
...
export const generatedSchema = {
  ...
  RootQueryToZombieConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToZombieConnectionEdge]" },
    nodes: { __type: "[Zombie]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToZombieConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Zombie" },
  },
  RootQueryToZombieConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  Zombie: {
    ...
    parentDatabaseId: { __type: "Int" },
    parentId: { __type: "ID" },
    preview: { __type: "ZombieToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  mutation: {
    ...
    createZombie: {
      __type: "CreateZombiePayload",
      __args: { input: "CreateZombieInput!" },
    },
    deleteCategory: {
    ...
    deleteZombie: {
      __type: "DeleteZombiePayload",
      __args: { input: "DeleteZombieInput!" },
    },
    ...
    updateZombie: {
      __type: "UpdateZombiePayload",
      __args: { input: "UpdateZombieInput!" },
    },
  },
  query: {
    __typename: { __type: "String!" },
    ...
    zombie: {
      __type: "Zombie",
      __args: { asPreview: "Boolean", id: "ID!", idType: "ZombieIdType" },
    },
    zombieBy: {
      __type: "Zombie",
      __args: { id: "ID", uri: "String", zombieId: "Int" },
    },
    zombies: {
      __type: "RootQueryToZombieConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToZombieConnectionWhereArgs",
      },
    },
  },
  subscription: {},
  [SchemaUnionsKey]: {
    ...
    ContentNode: ["MediaItem", "Page", "Post", "Rabbit", "Zombie"],
    HierarchicalContentNode: ["MediaItem", "Page", "Rabbit", "Zombie"],
    NodeWithAuthor: ["MediaItem", "Page", "Post"],
    NodeWithComments: ["MediaItem", "Page", "Post"],
    NodeWithTemplate: ["MediaItem", "Page", "Post", "Rabbit", "Zombie"],
    NodeWithTitle: ["MediaItem", "Page", "Post", "Rabbit", "Zombie"],
    MenuItemObjectUnion: [
      "Category",
      "Page",
      "Post",
    ...
    NodeWithContentEditor: ["Page", "Post", "Rabbit", "Zombie"],
...
export interface ContentNode {
  __typename?: "MediaItem" | "Page" | "Post" | "Rabbit" | "Zombie";
  /**
...
/**
 * The payload for the createZombie mutation
 */
export interface CreateZombiePayload {
  __typename?: "CreateZombiePayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteZombie mutation
 */
export interface DeleteZombiePayload {
  __typename?: "DeleteZombiePayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface HierarchicalContentNode {
  __typename?: "MediaItem" | "Page" | "Rabbit" | "Zombie";
  /**
...
export interface NodeWithContentEditor {
  __typename?: "Page" | "Post" | "Rabbit" | "Zombie";
  /**
...
/**
 * Connection between the RootQuery type and the zombie type
 */
export interface RootQueryToZombieConnection {
  __typename?: "RootQueryToZombieConnection";
  /**
   * Edges for the RootQueryToZombieConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToZombieConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Zombie>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToZombieConnectionEdge {
  __typename?: "RootQueryToZombieConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateZombie mutation
 */
export interface UpdateZombiePayload {
  __typename?: "UpdateZombiePayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Zombie {
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the zombie object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  parentId?: Maybe<ScalarsEnums["ID"]>;
  /**
   * Connection between the zombie type and the zombie type
   */
  preview?: Maybe<ZombieToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  zombieId: ScalarsEnums["Int"];
}

/**
 * Connection between the zombie type and the zombie type
 */
export interface ZombieToPreviewConnectionEdge {
  __typename?: "ZombieToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Zombie>;
...
export interface Query {
  ...
  zombie: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<ZombieIdType>;
  }) => Maybe<Zombie>;
  zombieBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    uri?: Maybe<Scalars["String"]>;
    zombieId?: Maybe<Scalars["Int"]>;
  }) => Maybe<Zombie>;
  zombies: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToZombieConnectionWhereArgs>;
  }) => Maybe<RootQueryToZombieConnection>;
}
...
export interface SchemaObjectTypes {
  ...
  CreateZombiePayload: CreateZombiePayload;
  ...
  DeleteZombiePayload: DeleteZombiePayload;
  ...
  RootQueryToZombieConnection: RootQueryToZombieConnection;
  RootQueryToZombieConnectionEdge: RootQueryToZombieConnectionEdge;
  ...
  UpdateZombiePayload: UpdateZombiePayload;
  User: User;
  UserRole: UserRole;
  ...
  Zombie: Zombie;
  ZombieToPreviewConnectionEdge: ZombieToPreviewConnectionEdge;
}
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ZombieIdType: ZombieIdType | undefined;
}
